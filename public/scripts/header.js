/* Shared header logic used across pages:
   - profile menu / login handling
   - search handling
   - search results modal display
   - token refresh
*/

// Note: include this script only after declaring API_BASE
...
(function () {
  ...
  // Expose a small API if other scripts want to call updateProfileMenu or re-check auth:
  window.Header = window.Header || {};
  window.Header.updateProfileMenu = updateProfileMenu;
  window.Header.checkAuthStatus = checkAuthStatus;
})();